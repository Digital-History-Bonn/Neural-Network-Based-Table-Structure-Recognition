...
def validsplitsanitytest(
    validpath: str = f"{Path(__file__).parent.absolute()}/../data/Tablesinthewild",
    validfile: str = f"{Path(__file__).parent.absolute()}/../data/Tablesinthewild/split.json",
):
