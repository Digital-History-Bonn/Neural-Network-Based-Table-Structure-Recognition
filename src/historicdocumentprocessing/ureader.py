...
from pipeline.utils import set_args, add_config_args
...
def testloop(testnr:str, pretrained: str = 'Mizukiluke/ureader-v1',
    ...
    for impath in tqdm(imgs):
        ...
        sentences = interface.do_generate(prompt, [impath], model=model, tokenizer=tokenizer1,
